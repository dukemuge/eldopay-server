...
import com.eldopay.companyservice.configuration.MpesaConfig;
import com.eldopay.companyservice.dtos.mpesa.*;
import com.eldopay.companyservice.utils.AlphaNumericGenerator;
import com.eldopay.companyservice.utils.HelperUtility;
import com.eldopay.companyservice.utils.Constants;
...
import static com.eldopay.companyservice.utils.MpesaConstant.*;
...
public class DarajaApiImpl implements DarajaApi {
    ...
    public CommonSyncResponse checkAccountBalance() {
        ...
        checkAccountBalanceRequest.setSecurityCredential(HelperUtility.getSecurityCredentials(mpesaConfig.getB2cInitiatorPassword()));
    ...
    public StkPushSyncResponse performStkPushTransaction(InternalStkPushRequest internalStkPushRequest) {
        ...
        externalStkPushRequest.setAccountReference(AlphaNumericGenerator.generateAlphanumericString());
